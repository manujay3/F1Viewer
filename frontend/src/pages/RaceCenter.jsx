      ...
      <div className="max-w-6xl mx-auto">
        ...
        {selectedRace && (
          <div className="bg-gray-800 rounded-lg border border-gray-700 p-6 shadow-xl">
            ...
            {/* 🛡️ SAFETY SHIELD & TRACK VISUALIZER */}
            {raceResults.length > 0 && (
              <div className="bg-slate-900 p-4 rounded-xl border border-gray-700 mb-8 shadow-inner">
                <TrackVisualizer 
                  year={2023} 
                ...
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody>
                    {raceResults.map((driver, i) => (
                      <tr 
                        key={i} 
                        // 🏎️ Passing the 3-letter Abbreviation directly to the state!
                        onClick={() => setSelectedDriver(driver.Abbreviation)}
                        className={`border-b border-gray-750 hover:bg-gray-700/50 cursor-pointer transition-colors ${selectedDriver === driver.Abbreviation ? 'bg-slate-800 border-l-4 border-l-red-600' : ''}`}
                      >
